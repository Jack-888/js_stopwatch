...
var _stopwatch = __webpack_require__(5);
...
startPauseId.addEventListener('click', function () {
...
fixationId.addEventListener('click', function () {
    stopwatch.fixation();
});
...
var fixationListHtmlId = document.getElementById("fixation-list");
var displayHtmlId = document.getElementById("display");
var startPauseHtmlId = document.getElementById("startPause");

var TimeStopwatch = function () {
    function TimeStopwatch() {
        _classCallCheck(this, TimeStopwatch);
    }

    _createClass(TimeStopwatch, [{
        key: "startPauseStopwatch",


        ////////////// Public methods //////////////

        value: function startPauseStopwatch() {
        ...
        key: "_htmlSendFormatting",
        value: function _htmlSendFormatting(hour, min, sec, ms) {
            return displayHtmlId.innerHTML = (hour > 9 ? hour : "0" + hour) + ":" + (min > 9 ? min : "0" + min) + ":" + (sec > 9 ? sec : "0" + sec) + "." + (ms > 99 ? ms : ms > 9 ? "0" + ms : "00" + ms);
        }
    }]);
